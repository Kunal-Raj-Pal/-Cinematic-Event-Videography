   ...
   <>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="font-serif font-black text-4xl md:text-5xl text-gray-800 mb-6">Let's Create Together</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to tell your story? Get in touch and let's discuss how we can capture your special moments.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Contact Form */}
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 text-lg flex items-center justify-center gap-2"
                >
...
<span>{result}</span>
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div>
              <h3 className="font-serif font-bold text-2xl text-gray-800 mb-6">Get in Touch</h3>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                We'd love to hear about your upcoming event. Whether it's an intimate gathering or a grand celebration,
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">anuragvideomixingzonejnp@gm
                    ail.com</div>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg">
              <h4 className="font-serif font-bold text-lg text-gray-800 mb-3">Response Time</h4>
