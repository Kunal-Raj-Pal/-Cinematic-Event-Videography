    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="font-serif font-black text-2xl mb-4">Anurag Video Mixing Zone</div>
            <p className="text-gray-300 leading-relaxed mb-6">
              Crafting cinematic stories that capture the essence of your most precious moments. Every frame tells a
              story, every story becomes a legacy.
            </p>
            <div className="flex gap-4">
              <a href="https://www.instagram.com/anurag_video_mixing_zone?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="bg-gray-700 p-2 rounded-full hover:bg-purple-600 transition-colors">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center p-2">
          <p className="text-gray-400 text-sm items-center justify-center md:gap-2">
             © 2025 - <span className='font-bold'>Anurag Video Mixing Zone</span>. <br />Designed & Developed with ❤️ by <a target='_blank' href="https://www.linkedin.com/in/kunal-raj-pal">Kunal Raj Pal</a>
          </p>
        </div>
    </footer>
    </>
