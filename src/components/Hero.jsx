  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="bg-white/10  backdrop-blur-md relative z-10 text-center max-w-4xl mx-auto px-6 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              variant="outline"
              size="lg"
              className="border-gray-300 rounded-xl text-gray-700 hover:bg-gray-500 hover:text-white transition-all duration-200 px-8 py-4 text-lg flex items-center gap-2 bg-transparent"
              target="_blank"
            >
              Watch Reel
            </a>
