    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="font-serif font-black text-4xl md:text-5xl text-gray-800 mb-6">Our Portfolio</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Each project tells a unique story. Discover how we capture the essence of every moment.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <div className="group relative aspect-video overflow-hidden">
                  ...
                  {/* Overlay */}
                  <div
                    className='bg:white/10 group-hover:backdrop-blur absolute inset-0 transition-opacity duration-300 flex items-center justify-center'
                  >
